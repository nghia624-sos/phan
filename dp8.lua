...
local function attackLoop()
	while running and currentTarget and currentTarget:FindFirstChild("Humanoid") do
		pcall(function()
			currentTarget.Humanoid:TakeDamage(1) -- có thể thay bằng click nếu muốn
		end)
		task.wait(0.5)
	end
end

-- Chạy tròn quanh mục tiêu
...
local function moveToTarget()
	...
	repeat
		task.wait(0.1)
	until not running or (hrp.Position - targetPos).Magnitude < radius
end
