...
-- Quay vòng bằng TweenService
local function tweenAroundTarget(target)
	...
	local tween = TweenService:Create(hrp, tweenInfo, {CFrame = CFrame.new(goalPos, target.HumanoidRootPart.Position)})
	tween:Play()
end
...
RunService.Heartbeat:Connect(function()
	if running and currentTarget and currentTarget:FindFirstChild("HumanoidRootPart") then
		...
		if distance > radius then
			...
			tweenAroundTarget(currentTarget)
		end
