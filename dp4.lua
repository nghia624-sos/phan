-- TT:dongphandzs1 - Fram NPC gần nhất + Hiển thị hitbox + Tăng sát thương
...
createSlider("Kích thước sát thương", 1, 20, 5, 200, function(val)
...
createButton("Bật/Tắt Hitbox", 250, function()
    ...
    if showHitbox then
        ...
        if tool and tool:FindFirstChild("Handle") then
            ...
            hitboxPart = Instance.new("BoxHandleAdornment")
            hitboxPart.Name = \"Hitbox\"
            hitboxPart.Adornee = handle
            hitboxPart.Size = hitboxSize
            hitboxPart.AlwaysOnTop = true
            hitboxPart.ZIndex = 10
            hitboxPart.Transparency = 0.3
            hitboxPart.Color3 = Color3.fromRGB(255, 0, 0)
