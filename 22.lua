...
-- Menu Fram NPC với tùy chỉnh bán kính và tốc độ bằng ô nhập số + tự động aim, đánh, bám đuôi mục tiêu
...
-- Di chuyển theo mục tiêu (bám đuôi)
local function followTarget(target)
    while running and target and target:FindFirstChild("HumanoidRootPart") and target:FindFirstChild("Humanoid") and target.Humanoid.Health > 0 do
        ...
        if dist > radius + 2 then
            ...
            return true -- đủ gần để chuyển sang chạy vòng
        end
