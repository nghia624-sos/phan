...
toggle.Text = "BẬT: Đánh Gần Nhất"
toggle.TextColor3 = Color3.new(1,1,1)
toggle.BackgroundColor3 = Color3.fromRGB(40,40,40)

local disLabel = Instance.new("TextLabel", frame)
disLabel.Text = "Khoảng cách vòng:"
...
RunService.Heartbeat:Connect(function()
	if running then
		...
		if dist > radius + 3 and not movingToTarget then
			moveToTarget(currentTarget)
		elseif dist <= radius + 3 then
...
toggle.MouseButton1Click:Connect(function()
	...
	toggle.Text = (running and "TẮT" or "BẬT") .. ": Đánh Gần Nhất"
end)
