...
passwordFrame.Size = UDim2.new(0, 250, 0, 100)
passwordFrame.Position = UDim2.new(0.5, -125, 0.5, -50)
passwordFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
passwordFrame.Visible = true
passwordFrame.Active = true

local input = Instance.new("TextBox", passwordFrame)
input.Size = UDim2.new(1, -20, 0, 30)
input.Position = UDim2.new(0, 10, 0, 10)
input.PlaceholderText = "Nhập mật khẩu"
input.Text = ""
input.ClearTextOnFocus = false

local confirmBtn = Instance.new("TextButton", passwordFrame)
confirmBtn.Size = UDim2.new(1, -20, 0, 30)
confirmBtn.Position = UDim2.new(0, 10, 0, 50)
