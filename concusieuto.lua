...
-- Auto Attack mới
local autoAttackRow, autoAttackToggle = createLabelToggle("Tự Động Đánh")
autoAttackRow.Parent = contentFrame
...
-- Auto attack an toàn (không loạn cảm ứng)
function autoAttack()
...
autoAttackToggle.MouseButton1Click:Connect(function()
	...
	autoAttackToggle.Text = autoAttackActive and "ON" or "OFF"
	autoAttackToggle.BackgroundColor3 = autoAttackActive and Color3.fromRGB(255, 170, 0) or Color3.fromRGB(60, 60, 60)
end)

-- Vòng lặp auto đánh riêng (an toàn cho mobile)
task.spawn(function()
	while true do
