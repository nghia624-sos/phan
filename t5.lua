...
-- Chạy vòng quanh mục tiêu từ vị trí hiện tại
RunService.Heartbeat:Connect(function(deltaTime)
	if running and currentTarget and currentTarget:FindFirstChild("HumanoidRootPart") then
		...
		-- Nếu chưa có offset ban đầu thì tạo từ vị trí hiện tại
		...
		-- Tính vị trí mới dựa trên góc quay
...
toggle.MouseButton1Click:Connect(function()
	...
	if running then
		...
		targetOffset = Vector3.new() -- reset offset
	end
